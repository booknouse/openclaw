...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.compaction.background": "Background Compaction",
  "agents.defaults.compaction.background.enabled": "Background Compaction Enabled",
  "agents.defaults.compaction.background.triggerRatio": "Background Compaction Trigger Ratio",
  "agents.defaults.compaction.background.maxOutputTokens": "Background Summary Output Tokens",
  "agents.defaults.compaction.background.timeoutMs": "Background Summary Timeout (ms)",
  ...
  "agents.defaults.compaction.models.primary.maxConcurrent": "Preferred Model Concurrency",
  "agents.defaults.compaction.models.secondary": "Secondary Compaction Model Pool",
  "agents.defaults.compaction.models.secondary.model": "Secondary Compaction Model",
  "agents.defaults.compaction.models.secondary.maxConcurrent": "Secondary Model Concurrency",
  ...
  "session.archive": "Permanent Runtime Archives",
  "session.archive.directory": "Runtime Archive Directory",
